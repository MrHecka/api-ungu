  ...
  <div class="overflow-y-auto max-[1024px]:h-120 max-[1024px]:py-2 rounded-xl bg-gray-800 bg-opacity-50 px-16 py-10 shadow-lg backdrop-blur-md max-sm:px-8">
    ...
    <form action="{{ route('profil.update') }}" method="POST">
        ...
        <div class="mb-4 text-lg">
          ...
          <input class="rounded-3xl border-none bg-purple-400 bg-opacity-50 px-32 items-center px-12 py-2 text-center text-inherit placeholder-slate-200 shadow-lg outline-none backdrop-blur-md placeholder-opacity-50" type="text" name="nama" value="{{ $nama }}" oninvalid="this.setCustomValidity('Isi Dulu Yang Bener Ganteng :)')" oninput="setCustomValidity('')" required />
        </div>
        <div class="mb-4 text-lg">
          ...
          <input class="rounded-3xl border-none bg-purple-400 bg-opacity-50 px-32 items-center px-12 py-2 text-center text-inherit placeholder-slate-200 shadow-lg outline-none backdrop-blur-md placeholder-opacity-50" type="number" name="nohp" value="{{ $nohp }}"  oninvalid="this.setCustomValidity('Isi Dulu Yang Bener Ganteng :)')" oninput="setCustomValidity('')" required />
        </div>
        <div class="mb-4 text-lg">
          ...
          <input class="rounded-3xl border-none bg-purple-400 bg-opacity-50 px-32 items-center px-12 py-2 text-center text-inherit placeholder-slate-200 shadow-lg outline-none backdrop-blur-md placeholder-opacity-50" type="email" name="email" value="{{ $email }}" oninvalid="this.setCustomValidity('Isi Dulu Yang Bener Ganteng :)')" oninput="setCustomValidity('')" required />
        </div>
        <div class="mb-4 text-lg">
          ...
          <button class="pl-4" type="button" onclick="copyText()"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
        ...
        <div class="mb-4 text-lg">
          ...
          <input class="rounded-3xl border-none bg-purple-400 bg-opacity-50 px-32 items-center inline px-12 py-2 text-center text-inherit placeholder-slate-200 shadow-lg outline-none backdrop-blur-md placeholder-opacity-50" type="text" placeholder="101.18.34.1,188.19.23.1" name="wlip" id="wlip" value="{{ $wlip }}" oninvalid="this.setCustomValidity('Isi Dulu Yang Bener Ganteng :)')" oninput="setCustomValidity('')"/>
        </div>
         <div class="mb-4 text-lg">
          ...
          Silahkan Selesaikan Captcha Terlebih Dahulu!</label>
          {!! NoCaptcha::display() !!}
          {!! NoCaptcha::renderJs() !!}
        </div>
