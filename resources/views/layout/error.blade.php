...
<div class="fixed z-10 inset-0 overflow-y-auto" id="error-modal">
  <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div class="animate-pulse inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all hover:scale-125 sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
