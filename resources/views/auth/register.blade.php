    ...
    <div class="text-white">
      ...
      <form action="{{ route('postregister') }}" method="POST">
        ...
        <div class="mb-4 text-lg">
          ...
          <input class="rounded-3xl border-none bg-purple-400 bg-opacity-50 items-center px-12 py-2 text-center text-inherit placeholder-slate-200 shadow-lg outline-none backdrop-blur-md placeholder-opacity-50" type="text" name="nama" value="{{ Session::get('nama') }}" placeholder="Budi Kopling" required />
        </div>
        ...
        <div class="mb-4 text-lg">
          ...
          <input class="rounded-3xl border-none bg-purple-400 bg-opacity-50 items-center px-12 py-2 text-center text-inherit placeholder-slate-200 shadow-lg outline-none backdrop-blur-md placeholder-opacity-50" type="email" value="{{ Session::get('email') }}" name="email" placeholder="emailku@gmail.com" required />
        </div>
        ...
        <div class="mb-4 text-lg">
          ...
          <input class="rounded-3xl border-none bg-purple-400 bg-opacity-50 items-center px-12 py-2 text-center text-inherit placeholder-slate-200 shadow-lg outline-none backdrop-blur-md placeholder-opacity-50" type="text" name="nohp" value="{{ Session::get('nohp') }}" placeholder="0878xxxxxx" pattern="[0-9]+" maxlength="13" required />
        </div>
        ...
        <div class="mb-4 text-lg">
          ...
          Password</label>
          <input class="rounded-3xl border-none bg-purple-400 bg-opacity-50 items-center px-12 py-2 text-center text-inherit placeholder-slate-200 shadow-lg outline-none backdrop-blur-md placeholder-opacity-50" type="password" name="password" placeholder="*********" required />
        </div>
        <div class="mt-8 flex justify-center text-lg text-white-900 font-bold">
          <button type="submit" class="rounded-3xl bg-purple-400 bg-opacity-50 px-10 py-2 text-white-900 dark:text-white shadow-xl backdrop-blur-md transition-colors duration-300 hover:bg-purple-600">Register</button>
        </div>
