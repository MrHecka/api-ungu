...
<div class="overflow-y-auto relative flex md:h-screen sm:w-full items-center justify-center bg-gray-900 bg-cover bg-no-repeat" style="background-image:url({{url('img/bgAuth.webp')}})">
  ...
  <div class="overflow-y-auto max-[700px]:h-120 max-[700px]:py-2 rounded-xl bg-gray-800 bg-opacity-50 px-16 py-5 shadow-lg backdrop-blur-md max-sm:px-8">
    <div class="text-white">
      <div class="mb-8 flex flex-col items-center">
        ...
        <br>
        <h1 class="mb-2 text-2xl font-bold">Daftar Akun Ngab.</h1>
