...
<div class="flex md:h-screen sm:h-full w-full items-center justify-center bg-gray-900 bg-cover bg-no-repeat" style="background-image:url({{url('img/bgAuth.webp')}})">

  <div class="rounded-xl bg-gray-800 bg-opacity-50 px-16 py-5 shadow-lg backdrop-blur-md max-sm:px-8">
    <div class="text-white">
      ...
      <form action="{{ route('postregister') }}" method="POST">
        ...
        <div class="mb-4 text-lg">
          ...
          <input class="rounded-3xl border-none bg-purple-400 bg-opacity-50 items-center px-12 py-2 text-center text-inherit placeholder-slate-200 shadow-lg outline-none backdrop-blur-md placeholder-opacity-50" type="text" name="nohp" value="{{ Session::get('nohp') }}" placeholder="0878xxxxxx" pattern="[0-9]+" maxlength="13" oninvalid="this.setCustomValidity('Isi Dulu Yang Bener Ganteng :)')" oninput="setCustomValidity('')" required />
        </div>
