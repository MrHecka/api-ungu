    ...
    <div class="text-white">
      ...
      <form action="{{ route('resetPass') }}" method="POST">
        ...
        <div class="mt-8 flex justify-center text-lg text-white-900 font-bold">
          <button type="submit" class="rounded-3xl bg-purple-400 bg-opacity-50 px-10 py-2 text-white-900 dark:text-white shadow-xl backdrop-blur-md transition-colors duration-300 hover:bg-purple-600">Kirim Email</button>
        </div>
